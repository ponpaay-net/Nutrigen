        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
            <div class="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
                ...
                <div class="md:col-span-3 md:col-start-7">
                    ...
                    <ul class="space-y-4">
                        <li><a href="#how-it-works" class="text-slate-500 hover:text-emerald-600 font-medium transition-all duration-300 text-sm flex items-center gap-2 hover:translate-x-1"><span class="w-1.5 h-1.5 rounded-full bg-slate-200"></span> Cara Kerja</a></li>
                        <li><a href="#faq" class="text-slate-500 hover:text-emerald-600 font-medium transition-all duration-300 text-sm flex items-center gap-2 hover:translate-x-1"><span class="w-1.5 h-1.5 rounded-full bg-slate-200"></span> FAQ & Bantuan</a></li>
